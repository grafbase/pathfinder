...
export const RESPONSE_EDITOR_DEFAULT_VALUE = ``;
export const RESPONSE_MODEL_NAME = "pathfinder-response-model";

export const VARIABLES_EDITOR_ID = "pathfinder-variables-editor";
export const VARIABLES_EDITOR_DEFAULT_VALUE = `{
